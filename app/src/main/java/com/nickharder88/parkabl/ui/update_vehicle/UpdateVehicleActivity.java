...
public class UpdateVehicleActivity extends SingleFragmentActivity {
    ...
    protected Fragment createFragment() {
        return UpdateVehicleFragment.newInstance(getIntent().getSerializableExtra(EXTRA_VEHICLE_MAKE).toString(), getIntent().getSerializableExtra(EXTRA_VEHICLE_MODEL).toString(), getIntent().getSerializableExtra(EXTRA_VEHICLE_LICENSE).toString());
    }

    public static Intent newIntent(Context packageContext, String make, String model, String license) {
